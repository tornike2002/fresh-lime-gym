...
const Hero = () => {
  return (
    <main
      id="home"
      className="bg-light-lime flex flex-col items-center px-6 justify-center md:flex-row"
    >
      <div className="max-w-custom mx-auto md:flex md:items-center">
        <div className="font-Rubik md:flex md:flex-col md:justify-start md:items-start">
          <h1
            className=" pb-[25px] text-center text-[41px] text-light-grey font-bold
        leading-[1.05] md:text-start"
          >
            Welcome to the one of the best Gym Freshlime
          </h1>
          <p className="text-[#555] text-center md:text-start pb-[36px]">
          ...
          <div className="flex items-center gap-3 justify-center">
            <button
             ...
             transition-colors duration-500 ease-in-out md:text-[14.4px]"
            >
              Get your month pass
            </button>
            <button
